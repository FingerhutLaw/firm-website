...
1. **Do not sign a severance agreement on the spot.** These are almost always presented as take-it-or-leave-it, but nearly always are negotiable in ways workers do not realize. And they almost always include a general release that gives up the very claims you may have. Take it home. Read it. Talk to a lawyer.
2. **Preserve your records** — offer letter, performance reviews, commendations, relevant emails, and messages from work systems you still have access to.
3. **Write down the timeline** of the last several months, including any complaints you made, accommodations you requested, leaves you took, and interactions with the decisionmaker.
4. **File for unemployment.** In New York and New Jersey, an at-will termination without misconduct qualifies for benefits. Filing does not waive any legal claims.
5. **Talk to a lawyer within days, not weeks.** Some deadlines are extremely short. The NYCHRL, NYSHRL, and NJLAD all have relatively long civil-action periods, but the federal EEOC deadline is 300 days from the last discriminatory act, and CEPA is one year.
